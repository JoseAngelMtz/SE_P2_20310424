...
public class SistemaExperto2 {
    ...
    public static void SistemaExperto_inicio() {
        ...
        int response = JOptionPane.showOptionDialog(null, "Este es un sistema experto de adivinanzas\n\nSigue las siguientes instrucciones:\n" +
            "     * Te presentaré 5 anfibios del género urodelo.\n" +
 ...
 public static void Adivinar() {
    ...
    if (questionIndex < questions.size()) {
        ...
        if (!encontrado) {
            String nombreVoca = JOptionPane.showInputDialog("El Pokémon no se encontró en el archivo. Por favor, ingresa el nombre del Pokémon:");
            
            // Guarda el nombre del Pokémon en el archivo "result.txt"
            guardarNombrePokemon(nombreVoca);
            
            // Guarda el registro en el archivo "solo.txt"
            guardarRespuestaSolo(nombreVoca +":"+ userSelections);
        }
...
public static String cargarUnResultadoDesdeArchivo(String archivo) {
    ...
    public static void Informacion() {
        String informacion = cargarInformacionDesdeArchivo("result.txt"); // Cargamos la informacion desde el archivo
